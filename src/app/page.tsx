      ...
      <section id="promotions" className="bg-[#C8820A] py-12 lg:py-14 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-12">
          <div className="text-center lg:text-left">
            ...
            <p className="text-3xl md:text-4xl font-bold text-white" style={{ fontFamily: "var(--font-playfair), serif" }}>{t.promo.heading}</p>
            <p className="text-white/75 text-sm mt-2 leading-relaxed">{t.promo.text}</p>
          </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
          ...
          <div className="relative bg-[#FAF6EF] w-full max-w-sm shadow-2xl overflow-hidden">
            ...
            <div className="bg-[#C8820A] px-6 pt-6 pb-7 text-white">
              ...
              <h3 className="text-2xl font-bold leading-tight" style={{ fontFamily: "var(--font-playfair), serif" }}>{t.modal.heading}</h3>
              <p className="text-white/70 text-sm mt-1.5">{t.modal.validity}</p>
            </div>
            <div className="px-6 py-6">
              ...
              <div className="border-2 border-dashed border-[#C8820A]/40 bg-[#C8820A]/5 px-5 py-4 flex items-center justify-between mb-1">
                <span className="text-2xl font-bold tracking-[0.15em] text-[#3B1F0A]" style={{ fontFamily: "var(--font-playfair), serif" }}>HIGHLANDS25</span>
              ...
              <p className="text-xs text-[#3B1F0A]/30 mb-6">{t.modal.saves}</p>
